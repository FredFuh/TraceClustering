...
csv_path = os.path.join(os.path.dirname(__file__), '..', 'test_data/sample_test2.csv').replace('\\', '/')
log_path = os.path.join(os.path.dirname(__file__), '..', 'test_data/test2.xes').replace('\\', '/')
...
output_csv_path = os.path.join(os.path.dirname(__file__), 'csvclustering.csv').replace('\\', '/')
output_log_path = os.path.join(os.path.dirname(__file__), 'clustered.xes').replace('\\', '/')
